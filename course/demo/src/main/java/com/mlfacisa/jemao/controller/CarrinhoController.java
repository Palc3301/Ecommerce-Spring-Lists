...
public class CarrinhoController {
	...
	@PostMapping("/{id}")
	public ResponseEntity<String> addPedidoNoCarrinho(@RequestParam("pedidoid") int pedidoId, @PathVariable("id") int id ) {
		carrinhoService.addPedido(pedidoId, id);
		return new ResponseEntity<String> ("PEDIDO ADICIONADO AO CARRINHO.", HttpStatus.OK);
	}
